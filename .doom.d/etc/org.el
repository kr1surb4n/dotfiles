;;; ../.dotfiles/.doom.d/etc/org.el -*- lexical-binding: t; -*-
...
;;(setq diary-file "~/docs/diary/diary.052022.org")
...
(add-hook 'org-mode-hook
          (lambda ()
            (setq org-agenda-file-to-front nil)
            (setq org-remove-file nil)))
...
(setq org-capture-templates
      (quote (("t" "todo" entry (file "~/docs/org/refile.org")
              ...
              ("r" "respond" entry (file "~/docs/org/refile.org")
